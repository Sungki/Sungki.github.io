...
var ASM_CONSTS = {
 ...
 184641: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 184734: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 184803: function() {return screen.width;},  
 184828: function() {return screen.height;},  
 184854: function() {return window.innerWidth;},  
 184884: function() {return window.innerHeight;},  
 184915: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 185010: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 185147: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
